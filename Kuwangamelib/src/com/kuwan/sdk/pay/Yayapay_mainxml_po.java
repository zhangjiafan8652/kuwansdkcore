...
import com.kuwan.sdk.xml.Basexml;
import com.kuwan.sdk.xml.GetAssetsutils;
import com.kuwan.sdk.xml.Layoutxml;
...
//		rl_title.setBackgroundColor(Color.parseColor("#3385FF"));
		rl_title.setBackgroundColor(Color.parseColor("#ec7600"));
...
//				"yaya_cancel_icon.png", mActivity));
		...
		tv_mYuanbao.setTextColor(Color.parseColor("#3385FF"));
...
//		tv_mMoney.setTextColor(Color.parseColor("#ff9900"));
		tv_mMoney.setTextColor(Color.RED);
...
//		TextView tv_fastpay = markView("请选择支付方式：如支付失败，请换种支付方式("+ViewConstants.SDKVERSION+"):");
		TextView tv_fastpay = markView("请选择支付方式：如支付失败,请联系客服QQ: "+CommonData.kefuqq);
...
//				DeviceUtil.WXPAYCODE);
		rl_mWxpay = createItemView("微信支付", "pay_wechat.png",
				DeviceUtil.WXPAYCODE);
