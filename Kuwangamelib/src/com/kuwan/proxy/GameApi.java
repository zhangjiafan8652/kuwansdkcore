...
public class GameApi {
	...
	@JavascriptInterface
	public void anmi() {
		Kuwangame.getInstance().anim(mActivity, new YYWAnimCallBack() {
	...
	@JavascriptInterface
	public void exit() {
		Kuwangame.getInstance().exit(mActivity, new YYWExitCallback() {
	...
	public void setdata( String roleId, String roleName,String roleLevel,String zoneId,String zoneName,String roleCTime,String ext) {
		...
		Kuwangame.getInstance().setData(mActivity, roleId, roleName, roleLevel, zoneId, zoneName, roleCTime, ext);
	}
}
