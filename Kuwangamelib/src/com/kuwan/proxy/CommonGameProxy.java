...
import com.kuwan.callback.YYWLoginHandleCallback;
...
import com.kuwan.implyy.ChargerImplyylianhe;
...
import com.kuwan.sdk.other.JFupdateUtils;
import com.kuwan.sdk.pay.GreenblueP;
import com.kuwan.utils.DeviceUtil;
import com.kuwan.utils.Handle;
import com.kuwan.utils.JSONUtil;
		...
		if (ViewConstants.ISKGAME) {
			...
			YYWMain.mUserCallBack = new YYWUserCallBack() {
				...
				public void onLoginSuccess(final YYWUser paramUser,
						Object paramObject) {
					Yayalog.loger("渠道登陆成功："+paramUser.toString());
					// TODO Auto-generated method stub
					//渠道登陆成功，去后台获取对应的自平台账号
					Handle.login_handler(mActivity, YYWMain.mUser.uid,
							...
							new YYWLoginHandleCallback() {
								...
								public void onSuccess(String response,
										String temp) {
									// TODO Auto-generated method stub
									Yayalog.loger("获取平台的账号的返回数据："+response);
									try {
											...
											mActivity
													.runOnUiThread(new Runnable() {
														...
														public void run() {
															...
															Yayalog.loger("渠道登陆成功："+yywUser.toString());
															//返回给研发登陆成功的数据
															userCallBack
																	.onLoginSuccess(
																			yywUser,
