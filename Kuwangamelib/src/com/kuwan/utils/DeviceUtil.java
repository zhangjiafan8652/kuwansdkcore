...
import com.kuwan.common.CommonData;
import com.kuwan.sdk.bean.PayMethod;

public class DeviceUtil {

	private static final String APP_ID = CommonData.sdkid;

	private static final String GAME_ID = "kuwan_game_id";

	private static final String UNION_GAME_ID = "union_game_id";

	private static final String UNION_ID = "union_id";

	private static final String SOURCE_ID = "kuwan_source_id";

	private static final String GAME_KEY = "kuwan_game_key";

	private static final String YAYAWAN_HELPER = "kuwan_helper";

	private static final String ISLANDSCAPE = "isLandscape";

	private static final String ISDEBUG = "isdebug";
	private static final String YAYAWAN_ORIENTATION = "kuwan_orientation";
	...
	public static String getGameInfo(Context paramContext, String name) {
		...
		if(name.equals("kuwan_orientation")){
			if (DeviceUtil.isLandscape(paramContext)) {
				return "landscape";
			}else {
				return "portrait";
	...
	public static boolean changeAcount(Context paramContext) {
		Bundle dataInfo;
		if (((dataInfo = getMetaDataInfo(paramContext)) == null)
				|| (!dataInfo.getBoolean("kuwan_nochangecount"))) {
			return false;
		}
		return dataInfo.getBoolean("kuwan_nochangecount");
	}
