...
/** 
 * 1.闪屏动画,在游戏启动时的第一个页面出现..只要保证游戏画面出来前调用即可 Kuwangame.getInstance().anim(this, new
* YYWAnimCallBack(){})
...
public class SplashActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Kuwangame.getInstance().launchActivityOnCreate(this);
	...
	protected void onNewIntent(Intent intent) {
		...
		Kuwangame.getInstance().launchActivityonOnNewIntent(intent);
